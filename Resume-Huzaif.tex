...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \vspace{-2mm}
    \begin{itemize}
    \item[] Spearheaded backend development for a scalable e-commerce platform using Laravel, designing and implementing RESTful APIs to support seamless integration with frontend systems and third-party services.
