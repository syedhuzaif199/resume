...
\item  An open source online graphical tool and simulator for Finite automata, Pushdown automata and Turing machines.
...
\end{itemize}
      ...
      {\textbf{Data Compression Tool}}\textbf{ | \href{https://github.com/syedhuzaif199/data-compression-tool}{\underline{Link}}}\hfill{\sl C}\\
          \vspace{-1mm}
\begin{itemize} \itemsep -3pt
\item[] A tool for compressing data files using Huffman coding.
\end{itemize}
          \vspace*{3mm}
      {\textbf{nn-c}}\textbf{ | \href{https://github.com/syedhuzaif199/nn-c}{\underline{Link}}}\hfill{\sl C}\\
          \vspace{-1mm}
\begin{itemize} \itemsep -3pt
\item[] A small neural networks builder and visualizer made using C and raylib
\end{itemize}
          \vspace*{3mm}
      {\textbf{Category Tree Renderer}}\textbf{ | \href{https://github.com/syedhuzaif199/category-tree}{\underline{Link}}}\hfill{\sl Python}\\
          \vspace{-1mm}
\begin{itemize} \itemsep -3pt
\item[] A small tool developed in Python that creates a random category tree and renders it using graphViz
\end{itemize}
          \vspace*{3mm}
...
\end{itemize}
      ...
      {\textbf{Image filters visualizer}}\textbf{ | \href{https://github.com/syedhuzaif199/image-filters-visualization}{\underline{Link}} | \href{https://syedhuzaif199.github.io/image-filters-visualization}{\underline{Website}}}\hfill{\sl JavaScript, HTML, CSS}\\
          \vspace{-1mm}
\begin{itemize} \itemsep -3pt
\item[] A web app for experimenting with image filters.
\end{itemize}
          \vspace*{3mm}
